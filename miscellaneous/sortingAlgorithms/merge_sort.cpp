...
void merge_sort(int arr[], int n) {
    ...
    int* first_half = new int[middle];
    int* second_half = new int[n - middle];
    ...
    merge_sort(first_half, middle);
    merge_sort(second_half, n - middle);
...
void timing_experiment(void (*func)(int*, int)) {
    // open output file
    ofstream my_file;
    my_file.open("merge_sort_runtimes.csv");
    my_file << "n, time\n";
